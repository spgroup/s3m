...
public class TemporallyReweightedPMBuilderBuilder implements PredictiveModelBuilderBuilder<TemporallyReweightedPM, TemporallyReweightedPMBuilder> {
    ...
    public Map<String, FieldValueRecommender> createDefaultParametersToOptimize() {
        ...
        parametersToOptimize.put(HALF_LIFE_OF_NEGATIVE, new FixedOrderRecommender(5.0, 10.0, 20.0, 50));
        parametersToOptimize.put(HALF_LIFE_OF_POSITIVE, new FixedOrderRecommender(5.0, 10.0, 20.0, 50));
    ...
    public TemporallyReweightedPMBuilder buildBuilder(final Map<String, Object> predictiveModelConfig) {
        ...
        return new TemporallyReweightedPMBuilder(wrappedBuilderBuilder.buildBuilder(predictiveModelConfig), new SimpleDateFormatExtractor()).halfLifeOfNegative(halfLifeOfNegative).halfLifeOfPositive(halfLifeOfPositive);
    }
}
