...
public class CDBPhysicalBTree<K extends Comparable<K>, V> extends CDBAbstractBTree<K, V> {
    ...
    private static class NodeOp extends CorfuDBObjectCommand {
        ...
        public long oidparam() {
            return m_oidparam;
        }

        public NodeOp(int _cmd, long _oid, int _index, int _num, long _oidparam) {
            m_cmd = _cmd;
            m_oidnode = _oid;
            m_childindex = _index;
            m_childcount = _num;
        ...
        public static NodeOp readChildCountCmd(long _oidnode) {
            return new NodeOp(CMD_READ_CHILD_COUNT, _oidnode, 0, 0, 0);
        }

        public static NodeOp readChildrenCmd(long _oidnode) {
            return new NodeOp(CMD_READ_CHILDREN, _oidnode, 0, 0, 0);
        }

        public static NodeOp readChildCmd(long _oidnode, int _index) {
            return new NodeOp(CMD_READ_CHILD, _oidnode, _index, 0, 0);
        }

        public static NodeOp writeChildCountCmd(long _oidnode, int _count) {
            return new NodeOp(CMD_WRITE_CHILD_COUNT, _oidnode, 0, _count, 0);
        }

        public static NodeOp writeChildCmd(long _oidnode, int _index, long _oidparam) {
            return new NodeOp(CMD_WRITE_CHILD, _oidnode, _index, 0, _oidparam);
        }
    }
    ...
    private static class Node<K extends Comparable<K>, V> extends CorfuDBObject {
        ...
        private Node(AbstractRuntime tr, long toid, int nChildren) {
            super(tr, toid);
        ...
        public void applyToObject(Object bs, ITimestamp timestamp) {
            NodeOp cc = (NodeOp) bs;
            switch(cc.cmd()) {
                case NodeOp.CMD_READ_CHILD_COUNT:
                    cc.setReturnValue(applyReadChildCount());
                    break;
                case NodeOp.CMD_WRITE_CHILD_COUNT:
                    applyWriteChildCount(cc.childcount());
                    break;
                case NodeOp.CMD_READ_CHILDREN:
                    cc.setReturnValue(applyReadChildren());
                    break;
                case NodeOp.CMD_READ_CHILD:
                    cc.setReturnValue(applyReadChild(cc.childindex()));
                    break;
                case NodeOp.CMD_WRITE_CHILD:
                    applyWriteChild(cc.childindex(), cc.oidparam());
                    break;
            }
        }
         ...
         */
        public int applyReadChildCount() {
            rlock();
            try {
                return m_nChildren;
            } finally {
         ...
         * @param n
         */
        public void applyWriteChildCount(int n) {
            wlock();
            try {
                m_nChildren = n;
            } finally {
         ...
         * @return
         */
        public long applyReadChild(int index) {
            rlock();
            try {
         ...
         * @param oid
         */
        public void applyWriteChild(int n, long oid) {
            wlock();
            try {
                m_vChildren[n] = oid;
            } finally {
    ...
    private static class EntryOp<K extends Comparable<K>, V> extends CorfuDBObjectCommand {
        ...
        private EntryOp(int _cmd, long _oid, K key, V value, long oidnext, boolean deleted) {
            m_cmd = _cmd;
            m_oid = _oid;
            m_key = key;
            m_value = value;
        ...
        public static <K extends Comparable<K>, V extends java.lang.Object> EntryOp<K, V> readKeyCmd(long _oid) {
            return new EntryOp<K, V>(CMD_READ_KEY, _oid, null, null, oidnull, false);
        }

        public static <K extends Comparable<K>, V extends java.lang.Object> EntryOp<K, V> readValueCmd(long _oid) {
            return new EntryOp<K, V>(CMD_READ_VALUE, _oid, null, null, oidnull, false);
        }

        public static <K extends Comparable<K>, V extends java.lang.Object> EntryOp<K, V> readNextCmd(long _oid) {
            return new EntryOp<K, V>(CMD_READ_NEXT, _oid, null, null, oidnull, false);
        }

        public static <K extends Comparable<K>, V extends java.lang.Object> EntryOp<K, V> readDeletedCmd(long _oid) {
            return new EntryOp<K, V>(CMD_READ_DELETED, _oid, null, null, oidnull, false);
        }

        public static <K extends Comparable<K>, V extends java.lang.Object> EntryOp<K, V> writeKeyCmd(long _oid, K _key) {
            return new EntryOp<K, V>(CMD_WRITE_KEY, _oid, _key, null, oidnull, false);
        }

        public static <K extends Comparable<K>, V extends java.lang.Object> EntryOp<K, V> writeValueCmd(long _oid, V _value) {
            return new EntryOp<K, V>(CMD_WRITE_VALUE, _oid, null, _value, oidnull, false);
        }

        public static <K extends Comparable<K>, V extends java.lang.Object> EntryOp<K, V> writeNextCmd(long _oid, long _oidnext) {
            return new EntryOp<K, V>(CMD_WRITE_NEXT, _oid, null, null, _oidnext, false);
        }

        public static <K extends Comparable<K>, V extends java.lang.Object> EntryOp<K, V> writeDeletedCmd(long _oid, boolean b) {
            return new EntryOp<K, V>(CMD_WRITE_DELETED, _oid, null, null, oidnull, b);
        }
    }
    ...
    private static class Entry<K extends Comparable<K>, V> extends CorfuDBObject {
        ...
        public Entry(AbstractRuntime tr, long toid, K _key, V _value, long _next) {
            super(tr, toid);
            key = _key;
            value = _value;
            oidnext = _next;
        ...
        public void applyToObject(Object bs, ITimestamp timestamp) {
            ...
            switch(cc.cmd()) {
                case EntryOp.CMD_READ_KEY:
                    cc.setReturnValue(applyReadKey());
                    break;
                case EntryOp.CMD_WRITE_KEY:
                    cc.setReturnValue(applyWriteKey(cc.key()));
                    break;
                case EntryOp.CMD_READ_VALUE:
                    cc.setReturnValue(applyReadValue());
                    break;
                case EntryOp.CMD_WRITE_VALUE:
                    cc.setReturnValue(applyWriteValue(cc.value()));
                    break;
                case EntryOp.CMD_READ_NEXT:
                    cc.setReturnValue(applyReadNext());
                    break;
                case EntryOp.CMD_WRITE_NEXT:
                    cc.setReturnValue(applyWriteNext(cc.oidnext()));
                    break;
                case EntryOp.CMD_READ_DELETED:
                    cc.setReturnValue(applyReadDeleted());
                    break;
                case EntryOp.CMD_WRITE_DELETED:
                    cc.setReturnValue(applyWriteDeleted(cc.deleted()));
                    break;
            }
        }
    ...
    public static class BTreeOp extends CorfuDBObjectCommand {
        ...
        private BTreeOp(int _cmd, long _oid, int _iparam, long _oidparam) {
            m_cmd = _cmd;
            m_oid = _oid;
            m_iparam = _iparam;
            m_oidparam = _oidparam;
        ...
        public static BTreeOp readSizeCmd(long _oid) {
            return new BTreeOp(CMD_READ_SIZE, _oid, 0, oidnull);
        }

        public static BTreeOp readHeightCmd(long _oid) {
            return new BTreeOp(CMD_READ_HEIGHT, _oid, 0, oidnull);
        }

        public static BTreeOp readRootCmd(long _oid) {
            return new BTreeOp(CMD_READ_ROOT, _oid, 0, oidnull);
        }

        public static BTreeOp writeSizeCmd(long _oid, int i) {
            return new BTreeOp(CMD_WRITE_SIZE, _oid, i, oidnull);
        }

        public static BTreeOp writeHeightCmd(long _oid, int i) {
            return new BTreeOp(CMD_WRITE_HEIGHT, _oid, i, oidnull);
        }

        public static BTreeOp writeRootCmd(long _oid, long _param) {
            return new BTreeOp(CMD_WRITE_ROOT, _oid, 0, _param);
        }
    }

    public CDBPhysicalBTree(AbstractRuntime tTR, StreamFactory tsf, long toid) {
        super(tTR, tsf, toid);
    ...
    public void applyToObject(Object bs, ITimestamp timestamp) {
        ...
        switch(cc.cmd()) {
            case BTreeOp.CMD_READ_HEIGHT:
                cc.setReturnValue(applyReadHeight());
                break;
            case BTreeOp.CMD_WRITE_HEIGHT:
                applyWriteHeight(cc.iparam());
                break;
            case BTreeOp.CMD_READ_ROOT:
                cc.setReturnValue(applyReadRoot());
                break;
            case BTreeOp.CMD_WRITE_ROOT:
                applyWriteRoot(cc.oidparam());
                break;
            case BTreeOp.CMD_READ_SIZE:
                cc.setReturnValue(applyReadSize());
                break;
            case BTreeOp.CMD_WRITE_SIZE:
                applyWriteSize(cc.iparam());
                break;
        }
    }
     ...
     * @return
     */
    private String print(Node<K, V> node, int height, String indent) {
        if (node == null) {
            return "";
        }
     ...
     * @return
     */
    private V search(long oidnode, K key, int height) {
     ...
     * @return
     */
    private Entry searchEntry(long oidnode, K key, int height) {
        Node<K, V> node = nodeById(oidnode);
        long[] children = readchildren(node);
        int nChildren = readchildcount(node);
        if (height == 0) {
     ...
     */
    private long insert(long oidnode, K key, V value, int height) {
        int idx = 0;
        Node<K, V> node = nodeById(oidnode);
        long[] children = readchildren(node);
        int nChildren = readchildcount(node);
     ...
     * @return
     */
    protected Node<K, V> nodeById(long noid) {
        rlock();
        try {
     ...
     * @return
     */
    protected Entry<K, V> entryById(long noid) {
        rlock();
        try {
     ...
     * @return
     */
    private Node<K, V> allocNode(int nChildren) {
     ...
     * @return
     */
    private Entry<K, V> allocEntry(K k, V v) {
     ...
     * @param oidchild
     */
    private void writechild(Node<K, V> node, int index, long oidchild) {
     ...
     * @param count
     */
    private void writechildcount(Node<K, V> node, int count) {
     ...
     * @param ckey
     */
    private void writekey(Entry<K, V> entry, Comparable ckey) {
     ...
     * @param value
     */
    private void writevalue(Entry<K, V> entry, V value) {
     ...
     * @param next
     */
    private void writenext(Entry<K, V> entry, long next) {
     ...
     * @param deleted
     */
    private void writedeleted(Entry<K, V> entry, boolean deleted) {
     ...
     * @return
     */
    private Comparable readkey(Entry<K, V> entry) {
     ...
     * @return
     */
    private boolean readdeleted(Entry<K, V> entry) {
     ...
     * @return
     */
    private Comparable readkey(long entryoid) {
     ...
     * @return
     */
    private V readvalue(Entry<K, V> entry) {
     ...
     * @return
     */
    private long readnext(Entry<K, V> entry) {
     ...
     * @return
     */
    private long readnext(long entryoid) {
        Entry<K, V> entry = entryById(entryoid);
        EntryOp<K, V> cmd = EntryOp.readNextCmd(entry.oid);
        if (!TR.query_helper(entry, null, cmd)) {
            return entry.applyReadNext();
     ...
     * @return
     */
    private long[] readchildren(Node<K, V> node) {
     ...
     * @return
     */
    private int readchildcount(Node<K, V> node) {
