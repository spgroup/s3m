...
public class CompilerHelperImpl implements CompilerHelper {
    ...
    //TODO reconsider it after closing CloudSlang file extensions & some real usecases
        ...
        for (File inputFile : fileCollection) {
            ...
            try {
                ...
                if (StringUtils.isNotEmpty(inputsFileContent)) {
                    @SuppressWarnings(value = { "unchecked" }) Map<String, ? extends Serializable> inputFileYamlContent = (Map<String, ? extends Serializable>) yaml.load(inputsFileContent);
    ...
    private Collection<File> listFiles(File directory, String[] extensions, boolean recursive, String[] excludedExtensions) {
