...
public final class FetchValue extends RiakCommand<FetchValue.Response, Location> {
    ...
    protected final RiakFuture<Response, Location> executeAsync(RiakCluster cluster) {
        RiakFuture<FetchOperation.Response, Location> coreFuture = cluster.execute(buildCoreOperation());
        CoreFutureAdapter<Response, Location, FetchOperation.Response, Location> future = new CoreFutureAdapter<Response, Location, FetchOperation.Response, Location>(coreFuture) {
            ...
            protected Response convertResponse(FetchOperation.Response coreResponse) {
                return new Response.Builder().withNotFound(coreResponse.isNotFound()).withUnchanged(coreResponse.isUnchanged()).withValues(coreResponse.getObjectList()).withVClock(coreResponse.getVClock()).withLocation(// for ORM
                location).build();
            }
    ...
    public static class Response extends KvResponseBase {
         ...
         * @ExcludeFromJavadoc 
         */
        protected abstract static class Init<T extends Init<T>> extends KvResponseBase.Init<T> {
    ...
    public static class Builder {
		 ...
		 */
        public <U extends java.lang.Object> Builder withOption(FetchOption<U> option, U value) {
