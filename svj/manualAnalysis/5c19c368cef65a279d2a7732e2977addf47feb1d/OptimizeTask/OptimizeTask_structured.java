...
public class OptimizeTask extends BaseTask<OptimizeParameters> {
    ...
    public void execute(OptimizeParameters parameters) throws TaskException {
        ...
        for (PdfSource<?> source : parameters.getSourceList()) {
            ...
            String outName = nameGenerator(parameters.getOutputPrefix()).generate(nameRequest().originalName(source.getName()).fileNumber(currentStep));
        ...
        for (COSName xObjectName : xObjectNames) {
            ...
            try {
                ...
                if (obj instanceof PDImageXObject) {
                    ...
                    File tmpImageFile = ImageOptimizer.optimize(imageXObject.getImage(), parameters.getImageQuality(), parameters.getImageDpi(), parameters.getImageMaxWidthOrHeight());
