...
public class ApiHelpMessageBodyWriter implements MessageBodyWriter<Documentation> {
    ...
    public long getSize(Documentation arg0, Class<?> arg1, Type arg2, Annotation[] arg3, MediaType arg4) {
        try {
     ...
     */
    public void writeTo(Documentation documentation, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, Object> httpHeaders, OutputStream entityStream) throws IOException, WebApplicationException {
        entityStream.write(getStringRepresentation(documentation));
        entityStream.flush();
    }
