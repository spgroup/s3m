...
public final  class  PlayerDiggingHandler  extends MessageHandler<PlayerDiggingMessage> {
	...
	<<<<<<< C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var1_2644645431313986074.java
@Override
		...
		if (state != PlayerDiggingMessage.STATE_DROP_ITEM && state != PlayerDiggingMessage.STATE_SHOOT_ARROW_EAT_FOOD) {
			...
			for (Protection p : protections) {
				if (p.contains(point) && !human.isOp()) {
					player.getSession().send(false, new BlockChangeMessage(x, y, z, minecraftID, block.getBlockData() & 0xF, rm));
...
>>>>>>> C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var2_4211491771643395462.java
