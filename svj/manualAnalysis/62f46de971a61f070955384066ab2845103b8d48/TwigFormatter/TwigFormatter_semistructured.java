...
public  class  TwigFormatter  implements IStructuredFormatter {
	...
	<<<<<<< C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var1_7297618281652215520.java
private StructuredFormatContraints fFormatContraints;=======
protected StructuredFormatContraints fFormatContraints = null;>>>>>>> C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var2_7428552852152821684.java
                    ...
                    for (int j = twigTokens.length - 1; j >= 0; j--) {
                        ...
                        if (/* endFormat >= end || */startFormat <= start
                            ...
                            if (phpToken.getType().equals(
                                    TwigRegionTypes.PHP_CURLY_OPEN)) {
                                if (j < twigTokens.length - 1 && j > 0) {
                                    if (twigTokens[j - 1].getType().equals(
                                            TwigRegionTypes.TWIG_DELIMITER)
                                            && document
                                    ...
                                    TwigRegionTypes.PHP_CURLY_CLOSE)) {
                                if (j > 0
                                        && (twigTokens[j - 1].getType().equals(
                                                TwigRegionTypes.PHP_SEMICOLON)
                                                || twigTokens[j - 1]
                                                        .getType()
                                                        .equals(TwigRegionTypes.PHP_CURLY_CLOSE) || twigTokens[j - 1]
                                                .getType()
    ...
    {
        return (tokenType == TwigRegionTypes.TWIG_COMMENT
                || tokenType == TwigRegionTypes.TWIG_COMMENT_TEXT || tokenType == TwigRegionTypes.TWIG_COMMENT_CLOSE);
    }
            ...
            IRegion lineInfo)
    {
        ...
        return ((checkedLineBeginState == TwigPartitionTypes.TWIG_DEFAULT) || (checkedLineBeginState == TwigPartitionTypes.TWIG_COMMENT_TEXT))
