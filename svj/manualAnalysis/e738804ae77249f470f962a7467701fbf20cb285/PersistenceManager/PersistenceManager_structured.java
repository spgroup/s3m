...
public class PersistenceManager {
	 ...
	 */
    public <T extends java.lang.Object> T merge(T entity) {
        if (log.isDebugEnabled()) {
	 ...
	 * @return Merged entity or a new proxified entity
	 */
    public <T extends java.lang.Object> T merge(final T entity, Options options) {
        if (log.isDebugEnabled()) {
    ...
    public void removeById(Class<?> entityClass, Object primaryKey, ConsistencyLevel writeLevel) {
        ...
        PersistenceContext context = initPersistenceContext(entityClass, primaryKey, OptionsBuilder.withConsistency(writeLevel));
        entityValidator.validatePrimaryKey(context.getIdMeta(), primaryKey);
        context.remove();
    }
	 ...
	 */
    public <T extends java.lang.Object> T find(Class<T> entityClass, Object primaryKey) {
	 ...
	 */
    public <T extends java.lang.Object> T find(final Class<T> entityClass, final Object primaryKey, ConsistencyLevel readLevel) {
        ...
        Validator.validateTrue(entityMetaMap.containsKey(entityClass), "The entity class \'%s\' is not managed by Achilles", entityClass.getCanonicalName());
        PersistenceContext context = initPersistenceContext(entityClass, primaryKey, OptionsBuilder.withConsistency(readLevel));
        entityValidator.validatePrimaryKey(context.getIdMeta(), primaryKey);
	 ...
	 */
    public <T extends java.lang.Object> T getReference(Class<T> entityClass, Object primaryKey) {
        if (log.isDebugEnabled()) {
	 ...
	 *            Consistency Level for read
	 */
    public <T extends java.lang.Object> T getReference(final Class<T> entityClass, final Object primaryKey, ConsistencyLevel readLevel) {
        if (log.isDebugEnabled()) {
	 ...
	 * 
	 */
    public <T extends java.lang.Object> T initialize(final T entity) {
	 ...
	 * 
	 */
    public <T extends java.lang.Object> Set<T> initialize(final Set<T> entities) {
	 ...
	 * 
	 */
    public <T extends java.lang.Object> List<T> initialize(final List<T> entities) {
        log.debug("Force lazy fields initialization for entity set {}", entities);
        for (T entity : entities) {
            initialize(entity);
        }
	 ...
	 * 
	 */
    public <T extends java.lang.Object> T initAndUnwrap(T entity) {
	 ...
	 * 
	 */
    public <T extends java.lang.Object> Set<T> initAndUnwrap(Set<T> entities) {
	 ...
	 * 
	 */
    public <T extends java.lang.Object> List<T> initAndUnwrap(List<T> entities) {
        return unwrap(initialize(entities));
    }
	 ...
	 * @return real object
	 */
    public <T extends java.lang.Object> T unwrap(T proxy) {
	 ...
	 */
    public <T extends java.lang.Object> List<T> unwrap(List<T> proxies) {
	 ...
	 */
    public <T extends java.lang.Object> Set<T> unwrap(Set<T> proxies) {
        log.debug("Unproxying set of entities {}", proxies);
        return proxifier.unwrap(proxies);
    }

    public <T extends java.lang.Object> SliceQueryBuilder<T> sliceQuery(Class<T> entityClass) {
	 ...
	 */
    public <T extends java.lang.Object> TypedQueryBuilder<T> typedQuery(Class<T> entityClass, String queryString, Object... boundValues) {
        return typedQueryInternal(entityClass, queryString, true, boundValues);
    }

    private <T extends java.lang.Object> TypedQueryBuilder<T> typedQueryInternal(Class<T> entityClass, String queryString, boolean normalizeQuery, Object... boundValues) {
        ...
        return new TypedQueryBuilder<T>(entityClass, daoContext, queryString, meta, contextFactory, true, normalizeQuery, boundValues);
    }
	 ...
	 * @return TypedQueryBuilder<T>
	 */
    public <T extends java.lang.Object> TypedQueryBuilder<T> indexedQuery(Class<T> entityClass, IndexCondition indexCondition) {
        ...
        final Select.Where query = QueryBuilder.select().from(entityMeta.getTableName()).where(QueryBuilder.eq(indexCondition.getColumnName(), bindMarker()));
	 ...
	 * @return TypedQueryBuilder<T>
	 */
    public <T extends java.lang.Object> TypedQueryBuilder<T> rawTypedQuery(Class<T> entityClass, String queryString, Object... boundValues) {
        ...
        return new TypedQueryBuilder<T>(entityClass, daoContext, queryString, meta, contextFactory, false, true, boundValues);
    }
