...
public class CQLPersistenceManager extends PersistenceManager<CQLPersistenceContext> {
    ...
    protected CQLPersistenceManager(Map<Class<?>, EntityMeta> entityMetaMap, CQLPersistenceContextFactory contextFactory, CQLDaoContext daoContext, ConfigurationContext configContext) {
    ...
    @Override
    public <T extends java.lang.Object> SliceQueryBuilder<CQLPersistenceContext, T> sliceQuery(Class<T> entityClass) {
	 ...
	 */
    public <T extends java.lang.Object> CQLTypedQueryBuilder<T> typedQuery(Class<T> entityClass, String queryString) {
        return typedQuery(entityClass, queryString, true);
    }

    private <T extends java.lang.Object> CQLTypedQueryBuilder<T> typedQuery(Class<T> entityClass, String queryString, boolean normalizeQuery) {
	 ...
	 * @return CQLTypedQueryBuilder<T>
	 */
    public <T extends java.lang.Object> CQLTypedQueryBuilder<T> indexedQuery(Class<T> entityClass, IndexCondition indexCondition) {
	 ...
	 * @return CQLTypedQueryBuilder<T>
	 */
    public <T extends java.lang.Object> CQLTypedQueryBuilder<T> rawTypedQuery(Class<T> entityClass, String queryString) {
        Validator.validateNotNull(entityClass, "The entityClass for typed query should not be null");
        Validator.validateNotBlank(queryString, "The query string for typed query should not be blank");
        Validator.validateTrue(entityMetaMap.containsKey(entityClass), "Cannot perform typed query because the entityClass \'%s\' is not managed by Achilles", entityClass.getCanonicalName());
        EntityMeta meta = entityMetaMap.get(entityClass);
