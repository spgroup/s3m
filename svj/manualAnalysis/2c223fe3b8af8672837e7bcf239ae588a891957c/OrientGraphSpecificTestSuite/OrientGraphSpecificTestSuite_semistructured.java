...
public  class  OrientGraphSpecificTestSuite  extends TestSuite {
	...
	<<<<<<< C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var1_4401208364346100358.java
...
public void testGetEdgesWithTargetVertex() throws Exception {
		...
		graph.shutdown();
	}>>>>>>> C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var2_5847154654824678695.java
	...
	public void testComplexMapProperty() throws Exception {
		...
		graph.shutdown();
		graphTest.dropGraph(((OrientGraphTest) graphTest).getWorkingDirectory()
				+ "/complex-map");
	}
