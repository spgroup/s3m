...
public  class  TimedTeleport  implements Runnable {
	...
	private final long timer_started;
		// time this task was initiated
	private final long timer_delay;
			// how long to delay the teleportPlayer
	...
	public void run()
	{
		...
		if (now > timer_started + timer_delay)
		{
			...
			{
				cancelTimer(false);
<<<<<<< C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var1_1136357042421083858.java
...
=======
				...
				timer_chargeFor.isAffordableFor(teleportOwner);
>>>>>>> C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var2_4968722143545025115.java
				if (timer_respawn)
				{
