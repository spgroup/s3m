...
public class InjectableObjectFactory implements AtmosphereObjectFactory<Injectable<?>> {
    ...
    @Override
    public <T extends java.lang.Object, U extends T> U newClassInstance(Class<T> classType, Class<U> defaultType) throws InstantiationException, IllegalAccessException {
     ...
     */
    /* @Override */
    public <T extends java.lang.Object> T inject(T instance) throws InstantiationException, IllegalAccessException {
     ...
     * @throws IllegalAccessException
     */
    public <U extends java.lang.Object> void applyMethods(U instance, Class<U> defaultType) throws IllegalAccessException {
    ...
    private <U extends java.lang.Object> void injectMethods(Set<Method> methods, U instance) throws IllegalAccessException {
     ...
     * @throws IllegalAccessException
     */
    public <U extends java.lang.Object> void injectInjectable(U instance, Class<? extends U> defaultType, AtmosphereFramework framework) throws IllegalAccessException {
        Set<Field> fields = getInheritedPrivateFields(defaultType);
        injectFields(fields, instance, framework, injectables);
    }

    public <U extends java.lang.Object> void injectFields(Set<Field> fields, U instance, AtmosphereFramework framework, LinkedList<Injectable<?>> injectable) throws IllegalAccessException {
     ...
     */
    public <U extends java.lang.Object> U getInjectable(Class<U> u) {
    ...
    protected <T extends java.lang.Object, U extends T> void nullFieldInjectionFor(Field field, U instance, Class<T> clazz) {
        for (InjectionListener i : listeners) {
            try {
    ...
    protected <T extends java.lang.Object, U extends T> void fieldInjectionException(Field field, U instance, Class<T> clazz, Exception ex) {
        for (InjectionListener i : listeners) {
            try {
    ...
    protected <T extends java.lang.Object, U extends T> void methodInjectionException(Method m, U instance, Class<T> clazz, Exception ex) {
        for (InjectionListener i : listeners) {
            try {
    ...
    protected <T extends java.lang.Object, U extends T> void preFieldInjection(Field field, U instance, Class<T> clazz) {
        for (InjectionListener i : listeners) {
            try {
    ...
    protected <T extends java.lang.Object, U extends T> void postFieldInjection(Field field, U instance, Class<T> clazz) {
        for (InjectionListener i : listeners) {
            try {
    ...
    protected <T extends java.lang.Object, U extends T> void preMethodInjection(Method method, U instance, Class<T> clazz) {
        for (InjectionListener i : listeners) {
            try {
    ...
    protected <T extends java.lang.Object, U extends T> void postMethodInjection(Method method, U instance, Class<T> clazz) {
        for (InjectionListener i : listeners) {
            try {
