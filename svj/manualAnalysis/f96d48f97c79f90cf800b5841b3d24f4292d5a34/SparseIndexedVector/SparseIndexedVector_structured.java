...
public class SparseIndexedVector extends ASparseIndexedVector {
    ...
    public double reduce(Op2 op, double init) {
        ...
        // reduce over any remaining zeros
        return op.reduceZeros(result, length - start);
    }
    ...
    public double reduce(Op2 op) {
        ...
        int start = 1;
        // start at data array element 0 if not at index 0, 1 otherwise
        int starti = (ixs[0] == 0) ? 1 : 0;
