...
public  class  PythonExecutor  implements Executor {
    ...
    <<<<<<< C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var1_909872824146491773.java
public PythonExecutionResult exec(String script, Map<String, Serializable> callArguments) {
=======
public PythonExecutionResult exec(String script, Map<String, Serializable> callArguments) {
        checkValidInterpreter();
>>>>>>> C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var2_4337387552604936932.java
        try {
            initInterpreter();
    ...
    <<<<<<< C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var1_5146846316530350988.java
public PythonEvaluationResult eval(String prepareEnvironmentScript, String expr, Map<String, Serializable> context) {
=======
public PythonEvaluationResult eval(String prepareEnvironmentScript, String expr, Map<String, Serializable> context) {
        checkValidInterpreter();
>>>>>>> C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var2_1145324126292533953.java
        try {
            initInterpreter();
