...
public  class  DOMElement  extends DOMNode  implements Element, NamedNodeMap {
  ...
  private static final Map<String, HtmlProperty> htmlProperties = new LRUMap(200);

		// use LURMap here to avoid infinite growing
  ...
  public static final org.structr.common.View publicView = new org.structr.common.View(DOMElement.class, PropertyView.Public, name, tag, path, parent, cypherQuery, xpathQuery, dataKey);

	
	
	

  public static final org.structr.common.View uiView = new org.structr.common.View(DOMElement.class, PropertyView.Ui, name, tag, path, parent, children, cypherQuery, xpathQuery, dataKey, _accesskey, _class, _contenteditable, _contextmenu, _dir, _draggable, _dropzone, _hidden, _id, _lang, _spellcheck, _style, _tabindex, _title, _onabort, _onblur, _oncanplay, _oncanplaythrough, _onchange, _onclick, _oncontextmenu, _ondblclick, _ondrag, _ondragend, _ondragenter, _ondragleave, _ondragover, _ondragstart, _ondrop, _ondurationchange, _onemptied, _onended, _onerror, _onfocus, _oninput, _oninvalid, _onkeydown, _onkeypress, _onkeyup, _onload, _onloadeddata, _onloadedmetadata, _onloadstart, _onmousedown, _onmousemove, _onmouseout, _onmouseover, _onmouseup, _onmousewheel, _onpause, _onplay, _onplaying, _onprogress, _onratechange, _onreadystatechange, _onreset, _onscroll, _onseeked, _onseeking, _onselect, _onshow, _onstalled, _onsubmit, _onsuspend, _ontimeupdate, _onvolumechange, _onwaiting);

	
	
	

  public static final org.structr.common.View htmlView = new org.structr.common.View(DOMElement.class, PropertyView.Html, _accesskey, _class, _contenteditable, _contextmenu, _dir, _draggable, _dropzone, _hidden, _id, _lang, _spellcheck, _style, _tabindex, _title, _onabort, _onblur, _oncanplay, _oncanplaythrough, _onchange, _onclick, _oncontextmenu, _ondblclick, _ondrag, _ondragend, _ondragenter, _ondragleave, _ondragover, _ondragstart, _ondrop, _ondurationchange, _onemptied, _onended, _onerror, _onfocus, _oninput, _oninvalid, _onkeydown, _onkeypress, _onkeyup, _onload, _onloadeddata, _onloadedmetadata, _onloadstart, _onmousedown, _onmousemove, _onmouseout, _onmouseover, _onmouseup, _onmousewheel, _onpause, _onplay, _onplaying, _onprogress, _onratechange, _onreadystatechange, _onreset, _onscroll, _onseeked, _onseeking, _onselect, _onshow, _onstalled, _onsubmit, _onsuspend, _ontimeupdate, _onvolumechange, _onwaiting);
  ...
  @Override public void render(SecurityContext securityContext, RenderContext renderContext, int depth) throws FrameworkException {
...
>>>>>>> YOURS
  ...
  @Override public Attr setAttributeNode(final Attr attr) throws DOMException {
  ...
  @Override public Attr removeAttributeNode(final Attr attr) throws DOMException {
    Attr attribute = getAttributeNode(attr.getName());
  ...
  @Override public NodeList getElementsByTagName(final String tagName) {
  ...
  @Override public String getAttributeNS(String string, String string1) throws DOMException {
    return null;
  }
  ...
  @Override public void setAttributeNS(String string, String string1, String string2) throws DOMException {
  }
  ...
  @Override public void removeAttributeNS(String string, String string1) throws DOMException {
  }
  ...
  @Override public Attr getAttributeNodeNS(String string, String string1) throws DOMException {
    return null;
  }
  ...
  @Override public Attr setAttributeNodeNS(Attr attr) throws DOMException {
    return null;
  }
  ...
  @Override public NodeList getElementsByTagNameNS(String string, String string1) throws DOMException {
    return null;
  }
  ...
  @Override public boolean hasAttributeNS(String string, String string1) throws DOMException {
    return false;
  }
  ...
  @Override public void setIdAttribute(String idString, boolean isId) throws DOMException {
    checkWriteAccess();
    try {
  ...
  @Override public void setIdAttributeNS(String string, String string1, boolean bln) throws DOMException {
  ...
  @Override public Node setNamedItem(Node node) throws DOMException {
  ...
  @Override public Node item(int i) {
  ...
  @Override public Node getNamedItemNS(String string, String string1) throws DOMException {
    return null;
  }
  ...
  @Override public Node setNamedItemNS(Node node) throws DOMException {
    return null;
  }
  ...
  @Override public Node removeNamedItemNS(String string, String string1) throws DOMException {
    return null;
  }
  ...
  @Override public Node doImport(final Page newPage) throws DOMException {
  ...
  @Override public List<GraphObject> getData(SecurityContext securityContext, AbstractNode referenceNode) throws FrameworkException {
    return null;
  }
