...
public class HttpFilterTest {
    ...
    public void testFiltering() throws Exception {
        ...
        final long[] proxyToServerRequestSendingNanos = new long[] { -1, -1, -1, -1, -1 };
        final long[] proxyToServerRequestSentNanos = new long[] { -1, -1, -1, -1, -1 };
        final long[] serverToProxyResponseReceivingNanos = new long[] { -1, -1, -1, -1, -1 };
        final long[] serverToProxyResponseReceivedNanos = new long[] { -1, -1, -1, -1, -1 };
        final long[] proxyToServerConnectionQueuedNanos = new long[] { -1, -1, -1, -1, -1 };
        final long[] proxyToServerResolutionStartedNanos = new long[] { -1, -1, -1, -1, -1 };
        final long[] proxyToServerResolutionSucceededNanos = new long[] { -1, -1, -1, -1, -1 };
        final long[] proxyToServerConnectionStartedNanos = new long[] { -1, -1, -1, -1, -1 };
        final long[] proxyToServerConnectionSSLHandshakeStartedNanos = new long[] { -1, -1, -1, -1, -1 };
        final long[] proxyToServerConnectionFailedNanos = new long[] { -1, -1, -1, -1, -1 };
        final long[] proxyToServerConnectionSucceededNanos = new long[] { -1, -1, -1, -1, -1 };
            ...
            public HttpFilters filterRequest(HttpRequest originalRequest) {
                ...
                return new HttpFiltersAdapter(originalRequest) {
                    ...
                    public void proxyToServerResolutionSucceeded(String serverHostAndPort, InetSocketAddress resolvedRemoteAddress) {
                        proxyToServerResolutionSucceededNanos[requestCount.get()] = now();
                    }
                    ...
                    public void proxyToServerConnectionSSLHandshakeStarted() {
                        proxyToServerConnectionSSLHandshakeStartedNanos[requestCount.get()] = now();
                    }
                    ...
                    public void proxyToServerConnectionSucceeded(ChannelHandlerContext serverCtx) {
                        proxyToServerConnectionSucceededNanos[requestCount.get()] = now();
        ...
        assertTrue("Response should have included the custom header from our pre filter", "1".equals(response1.getFirstHeader("Header-Pre").getValue()));
        assertTrue("Response should have included the custom header from our post filter", "2".equals(response1.getFirstHeader("Header-Post").getValue()));
    ...
    public void testResolutionStartedFilterReturnsUnresolvedAddress() throws Exception {
        ...
        final HttpProxyServer server = DefaultHttpProxyServer.bootstrap().withPort(PROXY_PORT).withFiltersSource(filtersSource).start();
