...
public  class  BaseSwiftTest  implements RuntimeTestSupport {
  ...
  @Override public void testTearDown() throws Exception {
  }
  ...
  @Override public void eraseTempDir() {
  }
  ...
  @Override public String getParseErrors() {
  ...
  @Override public String getANTLRToolErrors() {
  ...
  @Override public String execLexer(String grammarFileName, String grammarStr, String lexerName, String input, boolean showDFA) {
    generateParser(grammarFileName, grammarStr, null, lexerName);
  ...
  @Override public String execParser(String grammarFileName, String grammarStr, String parserName, String lexerName, String listenerName, String visitorName, String startRuleName, String input, boolean showDiagnosticErrors) {
    generateParser(grammarFileName, grammarStr, parserName, lexerName, "-visitor");
    writeFile(getTmpDir(), "input", input);
    return execParser(parserName, lexerName, startRuleName, showDiagnosticErrors, false);
  }
  ...
  private void buildProject(String projectDir, String projectName) {
    ...
    try {
      ...
      Pair<String, String> buildResult = runProcess(projectDir, SWIFT_CMD, "build", "-Xswiftc", "-I" + dylibPath, "-Xlinker", "-L" + dylibPath, "-Xlinker", "-lAntlr4", "-Xlinker", "-rpath", "-Xlinker", dylibPath);
  ...
  private String execParser(String parserName, String lexerName, String parserStartRuleName, boolean debug, boolean profile) {
    if (parserName == null) {
  ...
  private void writeParserTestFile(String parserName, String lexerName, String parserStartRuleName, boolean debug, boolean profile) {
...
<<<<<<< C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var1_4485376787489268343.java
    "let input = try ANTLRFileStream(args[1])\n"
=======
    "do {\n"
>>>>>>> C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var2_2165124859334658789.java
  ...
  private void writeLexerTestFile(String lexerName, boolean showDFA) {
    ST outputFileST = new ST("import Antlr4\n" + "import Foundation\n" + 
<<<<<<< C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var1_1799515687512292076.java
    "let input = try ANTLRFileStream(args[1])\n"
=======
    "setbuf(stdout, nil)\n"
>>>>>>> C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var2_2941578335333663143.java
