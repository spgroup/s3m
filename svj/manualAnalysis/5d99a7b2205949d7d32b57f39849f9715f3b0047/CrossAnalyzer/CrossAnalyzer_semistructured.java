...
<<<<<<< C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var1_457954285095619317.java
...
>>>>>>> C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var2_5532239713854773361.java
		info.setApp(client);
	...
	private CrossInfo parsePigeonServerTransaction(Transaction t, MessageTree tree) {
		...
		for (Message message : messages) {
			if (message instanceof Event) {
				String type = message.getType();
<<<<<<< C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var1_8634759206209291511.java
...
=======
				...
				if (type.equals("PigeonService.client") || type.equals("Service.client")) {
					crossInfo.setRemoteAddress(message.getName());
>>>>>>> C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var2_2739669386026950260.java
				}
