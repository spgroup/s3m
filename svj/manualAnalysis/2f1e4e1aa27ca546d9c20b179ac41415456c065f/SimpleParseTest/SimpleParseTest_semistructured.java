...
<<<<<<< C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var1_6088927181837549658.java
        assertToken(JsonToken.START_OBJECT, p.nextToken());
        assertToken(JsonToken.FIELD_NAME, p.nextToken());
        assertEquals("num", p.getCurrentName());
...
=======
        ...
        assertToken(JsonToken.FIELD_NAME, p.nextToken());
        assertEquals("num", p.getCurrentName());
>>>>>>> C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var2_7615220286431045434.java
...
;
    ...
    {
<<<<<<< C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var1_4402494741109144819.java
        String YAML = "nulls: [~ ]";
        JsonParser p = YAML_F.createParser(YAML);
=======
        final String YAML = "nulls: [~ ]";
        JsonParser p = YAML_F.createParser(YAML);
>>>>>>> C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var2_7017593013773725017.java
