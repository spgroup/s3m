...
public class CloneVisitor implements GenericVisitor<Node, Object> {
    ...
    public Node visit(FieldDeclaration _n, Object _arg) {
        ...
        FieldDeclaration r = new FieldDeclaration(_n.getRange(), _n.getModifiers(), annotations_, elementType_, variables_, arrayBracketPairsAfterType_);
        r.setComment(comment);
        return r;
    }
    ...
    public Node visit(VariableDeclaratorId _n, Object _arg) {
        ...
        VariableDeclaratorId r = new VariableDeclaratorId(_n.getRange(), _n.getName(), arrayBracketPairsAfterId_);
        r.setComment(comment);
        return r;
    }
    ...
    public Node visit(MethodDeclaration _n, Object _arg) {
        ...
        MethodDeclaration r = new MethodDeclaration(_n.getRange(), _n.getModifiers(), annotations_, typeParameters_, type_, arrayBracketPairsAfterElementType_, nameExpr_, parameters_, arrayBracketPairsAfterParameterList_, throws_, block_);
        r.setComment(comment);
        return r;
    }
    ...
    public Node visit(Parameter _n, Object _arg) {
        ...
        Comment comment = cloneNodes(_n.getComment(), _arg);
        List<ArrayBracketPair> arrayBracketPairsAfterType_ = visit(_n.getArrayBracketPairsAfterElementType(), _arg);
        Parameter r = new Parameter(_n.getRange(), _n.getModifiers(), annotations, type_, arrayBracketPairsAfterType_, _n.isVarArgs(), id);
        r.setComment(comment);
        return r;
    }
    ...
    public Node visit(FieldAccessExpr _n, Object _arg) {
        ...
        List<Type<?>> typeArguments_ = visit(_n.getTypeArguments(), _arg);
        Comment comment = cloneNodes(_n.getComment(), _arg);
        FieldAccessExpr r = new FieldAccessExpr(_n.getRange(), scope_, typeArguments_, _n.getField());
        r.setComment(comment);
        return r;
    }
    ...
    public Node visit(MethodCallExpr _n, Object _arg) {
        ...
        Comment comment = cloneNodes(_n.getComment(), _arg);
        MethodCallExpr r = new MethodCallExpr(_n.getRange(), scope_, typeArguments_, _n.getName(), args_);
        r.setComment(comment);
        return r;
    }
    ...
    public Node visit(VariableDeclarationExpr _n, Object _arg) {
        ...
        Comment comment = cloneNodes(_n.getComment(), _arg);
        List<ArrayBracketPair> arrayBracketPairsAfterType_ = visit(_n.getArrayBracketPairsAfterElementType(), _arg);
        VariableDeclarationExpr r = new VariableDeclarationExpr(_n.getRange(), _n.getModifiers(), annotations, type_, vars, arrayBracketPairsAfterType_);
        r.setComment(comment);
        return r;
    }
    ...
    public Node visit(ExplicitConstructorInvocationStmt _n, Object _arg) {
        ...
        List<Expression> args_ = visit(_n.getArgs(), _arg);
        Comment comment = cloneNodes(_n.getComment(), _arg);
        ExplicitConstructorInvocationStmt r = new ExplicitConstructorInvocationStmt(_n.getRange(), typeArguments_, _n.isThis(), expr_, args_);
        r.setComment(comment);
        return r;
    }
    ...
    public Node visit(CatchClause _n, Object _arg) {
        ...
        Comment comment = cloneNodes(_n.getComment(), _arg);
        CatchClause r = new CatchClause(_n.getRange(), param.getModifiers(), param.getAnnotations(), param.getElementType(), param.getId(), catchBlock);
        r.setComment(comment);
        return r;
    }
