...
public  class  IndexView  extends View {
  ...
  @Override public String toString() {
    return 
<<<<<<< C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var1_6091082140059301499.java
    "IndexView{" + "appRoot=\'" + appRoot + '\'' + ", apiDocs=\'" + apiDocs + '\'' + ", staticRoot=\'" + staticRoot + '\'' + ", apiRoot=\'" + apiRoot + '\'' + ", navColor=\'" + navColor + '\'' + ", defaultMemory=" + defaultMemory + ", defaultCpus=" + defaultCpus + ", defaultDisk=" + defaultDisk
=======
    "IndexView{" + "appRoot=\'" + appRoot + '\'' + ", apiDocs=\'" + apiDocs + '\'' + ", staticRoot=\'" + staticRoot + '\'' + ", apiRoot=\'" + apiRoot + '\'' + ", navColor=\'" + navColor + '\'' + ", defaultMemory=" + defaultMemory + ", defaultCpus=" + defaultCpus + ", hideNewDeployButton=" + hideNewDeployButton + ", hideNewRequestButton="
>>>>>>> C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var2_6843109706052214748.java
     + hideNewRequestButton + ", loadBalancingEnabled=" + loadBalancingEnabled + ", title=\'" + title + '\'' + ", slaveHttpPort=" + slaveHttpPort + ", slaveHttpsPort=" + slaveHttpsPort + ", defaultBounceExpirationMinutes=" + defaultBounceExpirationMinutes + ", defaultHealthcheckIntervalSeconds=" + defaultHealthcheckIntervalSeconds + ", defaultHealthcheckTimeoutSeconds=" + defaultHealthcheckTimeoutSeconds + ", defaultHealthcheckMaxRetries=" + defaultHealthcheckMaxRetries + ", defaultStartupTimeoutSeconds=" + defaultStartupTimeoutSeconds + ", runningTaskLogPath=\'" + runningTaskLogPath + '\'' + ", finishedTaskLogPath=\'" + finishedTaskLogPath + '\'' + ", commonHostnameSuffixToOmit=\'" + commonHostnameSuffixToOmit + '\'' + ", taskS3LogOmitPrefix=\'" + taskS3LogOmitPrefix + '\'' + ", warnIfScheduledJobIsRunningPastNextRunPct=" + warnIfScheduledJobIsRunningPastNextRunPct + ", shellCommands=\'" + shellCommands + '\'' + ", shortenSlaveUsageHostname=" + shortenSlaveUsageHostname + ", timestampFormat=\'" + timestampFormat + '\'' + ", showTaskDiskResource=" + showTaskDiskResource + ", timestampWithSecondsFormat=\'" + timestampWithSecondsFormat + '\'' + ", redirectOnUnauthorizedUrl=\'" + redirectOnUnauthorizedUrl + '\'' + ", extraScript=\'" + extraScript + '\'' + ", generateAuthHeader=" + generateAuthHeader + ", authCookieName=\'" + authCookieName + '\'' + ", authTokenKey=\'" + authTokenKey + '\'' + ", quickLinks=\'" + quickLinks + '\'' + "} " + super.toString();
  }
