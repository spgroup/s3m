...
public abstract class ProxyConnection implements Connection {
    ...
    static {
        ...
        // SQL92 disconnect error
        SQL_ERRORS.add("01002");
        // Sybase disconnect error
    ...
    final SQLException checkException(final SQLException sqle) {
        ...
        if (sqlState != null) {
            ...
            if (isForceClose && delegate != ClosedConnection.CLOSED_CONNECTION) {
                LOGGER.warn("{} - Connection {} marked as broken because of SQLSTATE({}), ErrorCode({})", poolEntry.getPoolName(), delegate, sqlState, sqle.getErrorCode(), sqle);
                leakTask.cancel();
    ...
    public final <T extends java.lang.Object> T unwrap(Class<T> iface) throws SQLException {
