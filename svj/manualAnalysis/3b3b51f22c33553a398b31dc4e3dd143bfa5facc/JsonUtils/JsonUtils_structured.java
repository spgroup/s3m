          ...
          if (type.equals("quantity")) {
            ...
            if (type.equals("int")) {
              ...
              if (type.equals("time")) {
                ...
                try {
                  return new WikidataValue(WikidataValue.Type.TIME, DateUtils.parseDate(time, "yyyyyyyyyyy-MM-dd\'T\'HH:mm:ss\'Z\'G"), element);
                } catch (ParseException e) {
                  throw new WpParseException("Invalid date: " + element);
                }
              } else {
                if (
<<<<<<< C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var1_3622892062166616021.java
                type.equals("wikibase-entityid") || type.equals("item")
=======
                Arrays.asList("globecoordinate", "other", "quantity").contains(type)
>>>>>>> C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var2_533382131289363812.java
                ) {
                  ...
                  return new WikidataValue(WikidataValue.Type.ITEM, element.getAsJsonObject().get("numeric-id").getAsInt(), element);
                } else {
                  if (Arrays.asList("globecoordinate", "other").contains(type)) {
