...
public class PlacementsTableModel extends AbstractTableModel {
    ...
    private String[] columnNames = new String[] { "Id", "Part", "Side", "X", "Y", "?", "Type", "Status", "Glue" };

    private Class[] columnTypes = new Class[] { PartCellValue.class, Part.class, Side.class, LengthCellValue.class, LengthCellValue.class, RotationCellValue.class, Type.class, Status.class, Boolean.class };
    ...
    public boolean isCellEditable(int rowIndex, int columnIndex) {
        return columnIndex == 1 || columnIndex == 2 || columnIndex == 3 || columnIndex == 4 || columnIndex == 5 || columnIndex == 6 || columnIndex == 8;
    }
