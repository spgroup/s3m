...
public class Clients extends InitializableObject {
    ...
    protected void internalInit() {
        ...
        for (final Client client : getClients()) {
            ...
            if (CommonHelper.isNotBlank(this.callbackUrl) && client instanceof IndirectClient) {
                ...
                if (indirectClient.isIncludeClientNameInCallbackUrl() && indirectClientCallbackUrl.indexOf(this.clientNameParameter + "=") < 0) {
    ...
    public String toString() {
        return CommonHelper.toString(this.getClass(), "callbackUrl", this.callbackUrl, "clientNameParameter", this.clientNameParameter, "clients", getClients());
    }
