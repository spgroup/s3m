...
public class Main {
    ...
    public static synchronized ClassLoader getClassLoader() {
        if (classLoader == null) {
            ...
            } catch (ClassNotFoundExceptionIOException | IllegalAccessException | IllegalArgumentException | InvocationTargetException | NoSuchMethodException | SecurityException |  e) {
