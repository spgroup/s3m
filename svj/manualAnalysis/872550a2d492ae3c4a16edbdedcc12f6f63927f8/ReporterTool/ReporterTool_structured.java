...
public class ReporterTool extends AbstractCMDTool {
    ...
    protected void showHelp(PrintStream os) {
        os.println("Options for tool \'Reporter\': --generate-png <filename> " + "--generate-csv <filename> " + "--input-jtl <data file> " + "--plugin-type <type> " + "[ " + "--width <graph width> " + "--height <graph height> " + "--granulation <ms> " + "--relative-times <yes/no> " + "--aggregate-rows <yes/no> " + "--paint-gradient <yes/no> " + "--paint-zeroing <yes/no> " + "--paint-markers <yes/no> " + "--prevent-outliers <yes/no> " + "--limit-rows <num of points> " + "--force-y <limit> " + "--hide-low-counts <limit> " + "--include-labels <labels list> " + "--exclude-labels <labels list> " + "--auto-scale <yes/no> " + "--line-weight <num of pixels> " + "--extractor-regexps <regExps list> " + "--success-filter <true/false> " + "]");
    }
