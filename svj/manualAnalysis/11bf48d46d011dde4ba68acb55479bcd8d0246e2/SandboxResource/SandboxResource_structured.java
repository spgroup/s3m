...
public class SandboxResource extends AbstractHistoryResource {
    ...
    @GET
    @Path(value = "/{taskId}/browse")
    @ApiOperation(value = "Retrieve information about a specific task\'s sandbox.")
    public SingularitySandbox browse(@ApiParam(value = "The task ID to browse") @PathParam(value = "taskId") String taskId, @ApiParam(value = "The path to browse from") @QueryParam(value = "path") String path) {
    ...
    @GET
    @Path(value = "/{taskId}/read")
    @ApiOperation(value = "Retrieve part of the contents of a file in a specific task\'s sandbox.")
    public MesosFileChunkObject read(@ApiParam(value = "The task ID of the sandbox to read from") @PathParam(value = "taskId") String taskId, @ApiParam(value = "The path to the file to be read") @QueryParam(value = "path") String path, @ApiParam(value = "Optional string to grep for") @QueryParam(value = "grep") Optional<String> grep, @ApiParam(value = "Byte offset to start reading from") @QueryParam(value = "offset") Optional<Long> offset, @ApiParam(value = "Maximum number of bytes to read") @QueryParam(value = "length") Optional<Long> length) {
        authorizationHelper.checkForAuthorizationByTaskId(taskId, user, SingularityAuthorizationScope.READ);
        final SingularityTaskHistory history = checkHistory(taskId);
