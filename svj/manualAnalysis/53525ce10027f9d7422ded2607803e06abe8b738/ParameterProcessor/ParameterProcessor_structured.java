      ...
      if (annotation instanceof ApiParam) {
        ...
        if (parameter instanceof AbstractSerializableParameter) {
          ...
          if (param.allowMultiple() || isArray) {
            ...
            p.items(PropertyBuilder.build(p.getType(), p.getFormat(), args)).type(ArrayProperty.TYPE).format(null).collectionFormat("multi");
          } else {
            if (!defaultValue.isEmpty()) {
...
<<<<<<< C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var1_4960575463876256707.java
...
>>>>>>> C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var2_2149342100796021362.java
