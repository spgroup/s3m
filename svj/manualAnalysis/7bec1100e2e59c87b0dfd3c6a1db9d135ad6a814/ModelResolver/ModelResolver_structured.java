...
public class ModelResolver extends AbstractModelConverter implements ModelConverter {
    ...
    protected void _addEnumProps(Class<?> propClass, Property property) {
        ...
        @SuppressWarnings(value = { "unchecked" }) Class<Enum<?>> enumClass = (Class<Enum<?>>) propClass;
            ...
            if (member != null && !propertiesToIgnore.contains(propName)) {
                ...
                if (mp != null && !mp.dataType().isEmpty()) {
                    ...
                    if (or.toLowerCase().startsWith("list[")) {
                        ...
                        if (or.toLowerCase().startsWith("map[")) {
                            int pos = or.indexOf(",");
                            if (pos > 0) {
                ...
                if (property == null) {
                    if (mp != null && StringUtils.isNotEmpty(mp.reference())) {
                        ...
                        if (member.getAnnotation(JsonIdentityInfo.class) != null) {
    ...
    private enum GeneratorWrapper {
        ...
        protected abstract Property processAsProperty(String propertyName, JavaType type, ModelConverterContext context, ObjectMapper mapper);

        protected abstract Property processAsId(String propertyName, JavaType type, ModelConverterContext context, ObjectMapper mapper);
