...
public  class  ScopedFxmlViewC  implements FxmlView<ScopedViewModelC> {
  ...
  @InjectViewModel public ScopedViewModelC viewModel;
  ...
  public void initialize() {
    ...
    ViewTuple<ScopedFxmlViewD, ScopedViewModelD> load = FluentViewLoader.fxmlView(ScopedFxmlViewD.class).viewModel(scopedViewModelD).
<<<<<<< C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var1_4522528865143391515.java
    providedScopes(new Example1Scope2())
=======
    context(context)
>>>>>>> C:\Users\GUILHE~1\AppData\Local\Temp\fstmerge_var2_5464733338487229274.java
    .providedScopes(new TestScope2()).load();
  ...
  public void loadCorrectScopedView() {
    ViewTuple<ScopedFxmlViewD, ScopedViewModelD> load2 = FluentViewLoader.fxmlView(ScopedFxmlViewD.class).providedScopes(new Example1Scope1(), new Example1Scope2()).load();
    root.getChildren().add(load2.getView());
    subViewDWithoutContextController = load2.getCodeBehind();
  }
