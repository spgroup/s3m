...
public class PreCompileValidatorImpl extends AbstractValidator implements PreCompileValidator {
    ...
    private void validateNavigation(Step currentStep, Deque<Step> steps, Set<String> resultNames, Set<String> reachableStepNames, Set<String> reachableResultNames, List<RuntimeException> errors) {
    ...
    private void validateResultsAreReachable(Set<String> reachableResultNames, Set<String> resultNames, List<RuntimeException> errors) {
