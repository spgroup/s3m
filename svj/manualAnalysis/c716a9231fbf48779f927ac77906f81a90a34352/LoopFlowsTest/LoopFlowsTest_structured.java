...
public class LoopFlowsTest extends SystemsTestsParent {
    ...
    private void verifyPersonMap(Map<String, StepData> stepsData) {
        ...
        StepData secondTask = stepsData.get(SECOND_STEP_KEY);
        StepData thirdTask = stepsData.get(THIRD_STEP_KEY);
        @SuppressWarnings(value = { "unchecked" }) Set<Map<String, Serializable>> actualContextSet = Sets.newHashSet(firstTask.getInputs(), secondTask.getInputs(), thirdTask.getInputs());
        ...
        @SuppressWarnings(value = { "unchecked" }) Set<Map<String, Serializable>> expectedContextSet = Sets.newHashSet(context1, context2, context3);
