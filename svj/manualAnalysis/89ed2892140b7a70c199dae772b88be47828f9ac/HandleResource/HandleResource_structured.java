...
public class HandleResource extends Resource {
    ...
    public org.dspace.rest.common.DSpaceObject getObject(@PathParam(value = "prefix") String prefix, @PathParam(value = "suffix") String suffix, @QueryParam(value = "expand") String expand, @javax.ws.rs.core.Context HttpHeaders headers) {
        ...
        try {
            ...
            processException("Could not read handle(prefix=" + prefix + "), (suffix=" + suffix + ") ContextException. Message:" + e.getMessage(), context);
        } finally {
