...
importPath = "C:\\Users\\Guilherme\\Desktop\\FPFN\\results\\" 

#path where the plots will be generated
exportPath = "C:\\Users\\Guilherme\\Desktop\\FPFN\\results\\html\\"
...
main <- function(){
	...
	fnassscenarios3 <- getdata("project","mergeScenarios","fnInitializationBlocksMergeScnarios",isrelative=FALSE)
	fnassscenarios4 <- getdata("project","mergeScenarios","fnAcidentalScenarios",isrelative=FALSE)
	fnassscenariost <- data.frame(fnassscenarios1["project"],fnassscenarios1["mergeScenarios"],fnassscenarios1["fnImportMergeScenarios"],fnassscenarios2["fnNewArtRefOldOneMergeScnarios"],fnassscenarios3["fnInitializationBlocksMergeScnarios"],fnassscenarios4["fnAcidentalScenarios"],fnassscenarios1["RatePercentual"] + fnassscenarios2["RatePercentual"] + fnassscenarios3["RatePercentual"] + fnassscenarios4["RatePercentual"])#joining differents types of fn
